...
>
    <a
        ...
        @endif
        @class([
            'fi-sidebar-item-button relative flex items-center justify-center gap-x-3 px-2 py-2 outline-none transition duration-75',
            'focus-visible:bg-gray-100 dark:focus-visible:bg-white/5' => filled($url),
            '' => $active,
        ])
    >
